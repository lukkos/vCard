...
.controller('CompanyCtrl', function($scope, $rootScope, CompanyFactory, FlashFactory,$http, $modal,$timeout, cfpLoadingBar) {
    var debugModePrefix = 'app_dev.php/';
    $scope.currentPage = 1;
    $scope.pageSize    = 5;
    
    $scope.CompaniesList = CompanyFactory.getList($scope.currentPage, $scope.pageSize);
